//a lógica de um tabuleiro de jogo, permitindo adicionar peças, verificar vitórias e
...
public class Tabuleiro {
    ...
    // atributo rows que armazena o número de linhas do tabuleiro.
    private int rows;

    // atributo columns que armazena o número de colunas do tabuleiro.
    private int columns;

    // Construtor que recebe o número de linhas e colunas do tabuleiro
    public Tabuleiro(int rows, int columns) {
        this.rows = rows; // atributo rows com o valor passado como parâmetro.
        this.columns = columns; // atributo columns com o valor passado como parâmetro.
        pecas = new Peca[rows][columns]; // matriz pecas com o tamanho especificado por rows e columns.
        initializePecas(); // para inicializar cada posição da matriz pecas com uma nova instância de Peca.
    }

    // Metodo que Percorre todas as posições do tabuleiro e inicializa cada peça
    private void initializePecas() {
        // Os loops for percorrem todas as posições da matriz pecas
